...
list       = make_list("RNA/GLMM_DEGs/GLMM_DEGs_3donors_ctrl_v1_TMM","_GLMMres.txt") 
...
write.table_FT_2(res_sum2,paste0("RNA/GLMM_DEGs/summary/GLMM_DEGs_3donors_ctrl_v1_TMM_sum.txt"))
# 410849=17863*23
...
res_sum2=fread_FT("RNA/GLMM_DEGs/summary/GLMM_DEGs_3donors_ctrl_v1_TMM_sum.txt")
...
pdf_3(paste0("RNA/GLMM_DEGs/fisher/GLMM_DEGs_3donors_ctrl_v1_TMM_NaiveCD4-5_fisher_bar.pdf"),h=4.5,w=4)
 plot(p)
dev.off()
